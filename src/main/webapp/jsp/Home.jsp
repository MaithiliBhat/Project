        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="https://cdn.pixabay.com/photo/2016/11/29/03/53/house-1867187_640.jpg" class="d-block w-100" alt="..." height="500px">
                <div class="carousel-caption d-none d-md-block">
                  <h5>Home decoration</h5>
                  <p>We sell the best products of all time.</p>
                </div>
              </div>
              <div class="carousel-item">
                <img src="https://cdn.pixabay.com/photo/2016/11/18/17/20/living-room-1835923_1280.jpg" class="d-block w-100" alt="..." height="500px">
                <div class="carousel-caption d-none d-md-block">
                  <h5>Home Decoration</h5>
              ...
              <div class="carousel-item">
                <img src="https://cdn.pixabay.com/photo/2016/04/18/13/53/room-1336497_640.jpg" class="d-block w-100" alt="..." height="500px">
                <div class="carousel-caption d-none d-md-block">
                  <h5>Home Decoration</h5>
                  <p>Best price .</p>
                </div>
          ...
          <h1 style="margin-left: 30%; color: white;margin-top: 45px;">A Modern,Full-servise Home Decor </h1>
          <p style="margin-left: 35%;color: white">At Home decor,we  believe health is not the just to impress others</p>
          <p style="margin-left: 30%;color: white">but to high your standards.It is our mission to help you feel better,live together,and become</p>
          <p style="margin-left: 45%;color: white">the best possible  you</p>
    
           <h4 style="margin-left: 15%;margin-top: 13vh;color: white">Make Your Space More Relaxing. ...</h4>
        
          <h4 style="margin-left: 15%;margin-top: 13vh;color: white">Increase Your Home's Value. ...</h4>
    
          <h4 style="margin-left: 15%;margin-top: 13vh;color: white">Explore Your Creativity. ...</h4>
    
          <img style="margin-left:60%; margin-top:-23%;  border-radius:75%;" src="https://cdn.pixabay.com/photo/2016/04/18/08/50/kitchen-1336160_640.jpg" alt="" height="400px" width="400px">
     <hr style="color: white;">
              <div class="card-group">
                <div class="card">
                  <img src="https://cdn.pixabay.com/photo/2017/07/09/03/19/home-2486092_640.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Dinning</h5>
                    <p class="card-text">A modern dining table is a must-have furniture item that will make your life easier if you have a large group of people over for a party or event..</p>
                    <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                  </div>
                </div>
                <div class="card">
                  <img src="https://cdn.pixabay.com/photo/2016/11/29/05/01/lights-1867437_640.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Lighting</h5>
                    <p class="card-text">Appropriate lighting, without glare or shadows, can reduce eye fatigue and headaches.</p>
                    <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                  </div>
                </div>
                <div class="card">
                  <img src="https://cdn.pixabay.com/photo/2017/06/13/22/42/kitchen-2400367_640.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Dinning</h5>
                    <p class="card-text">A modern dining table is a must-have furniture item that will make your life easier if you have a large group of people over for a party or event.</p>
                    <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
