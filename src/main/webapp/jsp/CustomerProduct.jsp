...
<body>
    <nav>
        ...
        <div id="part2">
            ...
            <div class="admin" style="position: relative;right:20px;top:6px">
	...
	<div id="carouselExampleSlidesOnly" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="https://cdn.pixabay.com/photo/2017/03/28/12/11/chairs-2181960_640.jpg" class="d-block w-100" alt="..."
					height="500em">
			</div>
			<div class="carousel-item">
				<img src="https://cdn.pixabay.com/photo/2017/08/27/10/16/interior-2685521_640.jpg" class="d-block w-100" alt="..."
					height="500em">
			</div>
			<div class="carousel-item">
				<img src="https://cdn.pixabay.com/photo/2014/08/11/21/40/bedroom-416062_640.jpg" class="d-block w-100" alt="..."
					height="500em">
			</div>
		</div>
	</div>
	...
	<div
		style="font-size: 50px; font-style: italic; position: relative; left: 50px;">Interior</div>
...
<li style="color:rgb(108, 108, 108);">Best Product</li>
<li style="color:rgb(108, 108, 108);">Dinning and chair</li>
<li style="color:rgb(108, 108, 108);">Dressing tables</li></p>
